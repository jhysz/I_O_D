...
def demo():
    ...
    site, epochs, angles = load_data('numbers.txt')
    # site, epochs, angles = load_data('obs_simu_1.txt')
    ## [7225.8071387611135, 0.001383257659564742, 98.63483132094376, 31.514277343072035, 105.12351795358107, 33.59441077141726]
    ...
    print('   a: ', orbit.classical()[0])
    print(' ecc: ', orbit.classical()[1])
    print(' inc: ', orbit.classical()[2])
    print('raan: ', orbit.classical()[3])
    print('   w: ', orbit.classical()[4])
    print('   M: ', orbit.classical()[5])
